...
public class ASanPham {
	...
	public String toString() {
		...
		String r = "ASanPham [id=" + id + ", tenSanPham=" + tenSanPham + ", mota=" + mota + ", donViTinh=" + donViTinh
				+ ", donGia=" + donGia + ", soLuong=" + soLuong + ", type=" + type + ", listUrl={" + list
				+ "}, giaNhap= " + giaNhap + "]";
...
// constructor đầy đủ bao gồm các thuộc tính
	public ASanPham(String id, String tenSanPham, String mota, String donViTinh, double donGia, double soLuong,
			String type, List<String> listUrl, double giaNhap) {
		this.id = id;
...
//    Currency vnd = Currency.getInstance(vn);
	...
	public Object[] toRowTable(View.event.EventAction event, double quantity) {
		return new Object[] { new ModelAction(this, event), id, tenSanPham, donViTinh, quantity,
				formatCurrencyVN(donGia) };
	}
}
