...
public class MaterialFactory {
	...
	public ASanPham createMaterial(String type, String id, String tenSanPham, String mota, String donViTinh,
			double donGia, double soLuong, List<String> listUrl, double giaNhap) {
