...
public class FixProduct extends JFrame {
	...
	public FixProduct(final MnProduct mnProduct) {
...
//		btCancel.setBorder(lineBorder);
		...
		btAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ASanPham select=VatLieuDao.getInstance().getVatLieu(mnProduct.getId());
				double donGia=txtSell.getText().equals("")?select.getDonGia():Double.parseDouble(txtSell.getText());
               String idnew=txtCode.getText().equals("")?select.getId():txtCode.getText();
               String ten=txtName.getText().equals("")?select.getTenSanPham():txtName.getText();
               String donViTinh=txtUnit.getText().equals("")?select.getDonViTinh():txtUnit.getText();
               double soLuong=txtAmount.getText().equals("")?select.getSoLuong():Double.parseDouble(txtAmount.getText());
               double giaNhap=txtBuy.getText().equals("")?select.getGiaNhap():Double.parseDouble(txtBuy.getText());
               String loai=txtCate.getText().equals("")?select.getType():txtCate.getText();
               mnProduct.setPropertyMaterial(mnProduct.getId(), ten, donViTinh, donGia, soLuong, loai,giaNhap, idnew);
               dispose();
			}
