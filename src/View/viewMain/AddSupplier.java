...
public class AddSupplier extends JFrame {
	...
	public AddSupplier(final MnSupplier mn) {
...
//		btCancel.setBorder(lineBorder);
		...
		btAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String id=txtCode.getText().equals("")?"":txtCode.getText();
				...
				double noCCC=txtDebt.getText().equals("")?0:Double.parseDouble(txtDebt.getText());
				String ghiChu=txtNote.getText().equals("")?"":txtNote.getText();
				mn.addNCC(id, ten, sdt, diaChi, noCCC, ghiChu);
				dispose();
			}
		});
