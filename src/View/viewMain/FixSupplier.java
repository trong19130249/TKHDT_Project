...
public class FixSupplier extends JFrame {
	...
	public FixSupplier(final MnSupplier mn) {
...
//		btCancel.setBorder(lineBorder);
		...
		btAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				NhaBanHang select=mn.getNBH(mn.getId());
				String id=txtCode.getText().equals("")?select.getId():txtCode.getText();
				String ten=txtName.getText().equals("")?select.getTen():txtName.getText();;
				int sdt=txtPhone.getText().equals("")?select.getSdt():Integer.parseInt(txtPhone.getText());
				String diaChi=txtAddress.getText().equals("")?select.getDiaChi():txtAddress.getText();
				double noCCC=txtDebt.getText().equals("")?select.getNoCCC():Double.parseDouble(txtDebt.getText());
				String ghiChu=txtNote.getText().equals("")?select.getGhiChu():txtNote.getText();
				mn.editNCC(id, ten, sdt, diaChi, noCCC, ghiChu);
				dispose();
			}
		});
