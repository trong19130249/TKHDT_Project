...
public class InformationStaff extends JPanel{
		...
		public InformationStaff(String userName, final MnAccount mn) {
			...
			panel7.add(lbSex);
//			panelRadio.add(rdMale);
//			panelRadio.add(rdFemale);
//			group.add(rdMale);
//			group.add(rdFemale);
//			panel7.add(panelRadio);
			panel7.add(jcbSex);
