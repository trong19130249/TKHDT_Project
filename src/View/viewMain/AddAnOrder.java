...
public class AddAnOrder extends JFrame {
	...
	public AddAnOrder(final MnOrders mn) {
		...
		container1.add(lbDeliverTo);
		container1.add(txtDeliverTo);
		container1.add(lbDateSet);
		container1.add(dateSet);
...
//		btCancel.setBorder(lineBorder);
		...
		btAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Date ngayLap = dateSet.getDate() == null ? new Date(System.currentTimeMillis())
						: new Date(ngayLapChon.getYear(), ngayLapChon.getMonth(), ngayLapChon.getDay());
