...
public class DetailAnOrder extends JFrame implements Observer{
	...
	private CTDonHangModelInterface data;
	...
	private MnOrders mn;
	private String idDh;
	public DetailAnOrder(CTDonHangModelInterface data,ChiTietHoaDonController con,String dh,MnOrders mn) {
		this.data=data;
		this.controller=con;
		this.mn=mn;
		this.idDh=dh;
		data.registerObserver((Observer) this);
		System.out.println("idkh="+idDh);
		data.setData(idDh);
...
//		panelTableIn2.setBorder(lineBorder);
		...
		btnFix.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (jTable.getSelectedRow() >= 0)new FixAnDetailOrder(dt);
			}
		});
		...
		btnDelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (jTable.getSelectedRow() >= 0)
					deleteChiTiet(getId(), getIdVatLieu());
			}
		});
