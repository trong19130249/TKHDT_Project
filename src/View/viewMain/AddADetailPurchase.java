...
public class AddADetailPurchase extends JFrame {
	...
	public AddADetailPurchase(final DetailAPurchase dt) {
		...
		container1.add(lbUnit);
		container1.add(txtUnit);
		txtSell.setEditable(false);
		container1.add(lbSell);
		container1.add(txtSell);
		container1.add(lbAmount);
		container1.add(txtAmount);
		txtCate.setEditable(false);
		container1.add(lbCate);
		container1.add(txtCate);
...
//		btCancel.setBorder(lineBorder);
		...
		btAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String idvl = txtCode.getText().equals("") ? ds.get(jcbName.getSelectedIndex()).getId()
						: txtCode.getText();
