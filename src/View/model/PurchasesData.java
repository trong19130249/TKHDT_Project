...
public class PurchasesData implements NhapHangModelInterface{
	private String[] columnNames = { "", "Chi tiết", "Mã nhập hàng","Mã NCC", "Tên nhà cung cấp", "Số ĐT", "Tổng tiền" };
	...
	public void setData() {
		...
		for(int i=0;i<rowData.length;i++) {
			...
			Object[] element= {false,"Xem",ls.getId(),ls.getCoSoNhap().getId(),ls.getCoSoNhap().getTen(),"0"+ls.getCoSoNhap().getSdt(),ls.thanhTien()};
			rowData[i]=element;
		}
	}
	@Override
