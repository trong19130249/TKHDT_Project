...
public class SignInSignUpData implements DangNhapDangXuatModelInterface {
	...
	public boolean signup(TaiKhoan cus) {
		...
		boolean addTk=false;
		boolean addNv=NhanVienDao.getInstance().addNhanVien(nv.getId(), nv.getTen(), nv.getSdt(), 
		nv.getTrangThai(), nv.getGhiChu(), nv.getGioiTinh(), nv.getEmail(), nv.getDiaChi(), nv.getChucVu());
		if(addNv) {
