...
public class ProductsData implements VatLieuModelInterface {
	// Mảng chứa tên các trường (table header) của bảng. Dữ liệu sẽ được
	// hiển thị ở dạng bảng
	...
	public void setData() {
		// Lấy ra tất cả các vật liệu có trong kho (trừ trường hợp bị vô
		// hiệu hóa)
		...
		for (int i = 0; i < rowData.length; i++) {
			...
			Object[] element = { false, vl.getId(), vl.getTenSanPham(), vl.getDonViTinh(), vl.getGiaNhap(),
					vl.getDonGia(), vl.getSoLuong(), vl.getType() };
			rowData[i] = element;
		}
	}
	...
	public boolean setProperty(String id, String ten, String donViTinh, double donGia, double soLuong, String loai,
		...
		// TODO Auto-generated method stub
		boolean result = VatLieuDao.getInstance().setProperty(id, ten, donViTinh, donGia, soLuong, loai, giaNhap,
				idnew);
